...
public class Main {
        ...
        do {
            switch (animalChoiceMenu(keyboard)) {
                ...
                case 4:
                    ...
                    System.out.println("Do you wish to save animals to a file ? (1 for yes/ 2 for no) ");
                ...
                case 5:
                    ...
                    System.out.println("************* Deserializing animal objects... ***************");
                    readObjectsFromFile();
                    break;
    ...
    public static void writeObjectsToFile(Tiger tiger, Penguin penguin, Dolphin dolphin) {
        ...
        try (ObjectOutputStream fileout = new ObjectOutputStream(new FileOutputStream("tiger.txt"))) {
            fileout.writeObject(tiger);
        ...
        try (ObjectOutputStream fileout = new ObjectOutputStream(new FileOutputStream("penguin.txt"))) {
            fileout.writeObject(penguin);
        ...
        try (ObjectOutputStream fileout = new ObjectOutputStream(new FileOutputStream("dolphin.txt"))) {
            fileout.writeObject(dolphin);
    ...
    public static void readObjectsFromFile() {
        ...
        try (ObjectInputStream readfile = new ObjectInputStream(new FileInputStream("tiger.txt"))) {
            tiger = (Tiger) readfile.readObject();
            System.out.println(tiger.toString());
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }

        try (ObjectInputStream readfile = new ObjectInputStream(new FileInputStream("penguin.txt"))) {
            penguin = (Penguin) readfile.readObject();
            System.out.println(penguin.toString());
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }

        try (ObjectInputStream readfile = new ObjectInputStream(new FileInputStream("dolphin.txt"))) {
            dolphin = (Dolphin) readfile.readObject();
